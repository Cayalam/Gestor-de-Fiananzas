...
public class IngresoDTO {
    ...
    public IngresoDTO(Long id, Long usuarioId, String usuario, String grupo, String categoria, Long categoriaId, String bolsillo, Long bolsilloId, BigDecimal monto, LocalDate fecha, String descripcion) {
        this.id = id;
